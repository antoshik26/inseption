if [ ! -f /var/www/wordpress/wp_config.php ]; then
	...
	wp core install --allow-root --url='dmadelei.42.fr' --title='WordPress for Inception' --admin_user=dmadelei --admin_password=11 --admin_email="admin@admin.com" --path='/var/www/wordpress';
